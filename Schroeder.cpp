...
*/
bool __stdcall CSchroeder::initialize()
{
	// Add your code here
...
*/
bool __stdcall CSchroeder::prepareForPlay()
{
	...
	in_APF2.setAPF_g(0.6);
	in_APF3.setAPF_g(0.6);
	APF1.setAPF_g(0.507);
	APF2.setAPF_g(0.507);
...
void CSchroeder::cookVariables()
{
	...
	in_APF3.setDelay_mSec(2.03);

	APF1.setDelay_mSec(1.0);
	APF2.setDelay_mSec(3.0);

	// adds to 30-45 mS, 1:1.5 ratio for smallest:largest
	//CF1.setDelay_mSec(7);
	//CF2.setDelay_mSec(13);
	//CF3.setDelay_mSec(11);
	//CF4.setDelay_mSec(9);

	CF1.setDelay_mSec(27);
	CF2.setDelay_mSec(31);
...
*/
bool __stdcall CSchroeder::processAudioFrame(float* pInputBuffer, float* pOutputBuffer, UINT uNumInputChannels, UINT uNumOutputChannels)
{
	// output = input -- change this for meaningful processing
	//
	// Do LEFT (MONO) Channel; there is always at least one input/one output
	// (INSERT Effect)
	float f_in = pInputBuffer[0];
	...
	// run through 3 short APF's
	in_APF1.processAudio(&f_temp, &f_temp);
	in_APF2.processAudio(&f_temp, &f_temp);
	in_APF3.processAudio(&f_temp, &f_temp);
	...
	// diffusion output APF's
	APF1.processAudio(&f_temp, &f_temp);
	APF2.processAudio(&f_temp, &f_out);
	
	
	pOutputBuffer[0] = ((100.0 - m_fWet_pct) / 100.0 ) * f_in + (m_fWet_pct / 100.0) * f_out;
	// Stereo-In, Stereo-Out (INSERT Effect)
	if (uNumOutputChannels == 2)
		pOutputBuffer[1] = ((100.0 - m_fWet_pct) / 100.0) * f_in + (m_fWet_pct / 100.0) * f_out;
	return true;
}
...
//
bool __stdcall CSchroeder::userInterfaceChange(int nControlIndex)
{
	cookVariables();
...
bool __stdcall CSchroeder::processAuxInputBus(audioProcessData* pAudioProcessData)
{
...
*/
bool __stdcall CSchroeder::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD, float fACMix, float fBDMix)
{
	// add your code here
...
*/
bool __stdcall CSchroeder::processRackAFXAudioBuffer(float* pInputBuffer, float* pOutputBuffer,
...
*/
bool __stdcall CSchroeder::processVSTAudioBuffer(float** inBuffer, float** outBuffer, UINT uNumChannels, int inFramesToProcess)
{
...
bool __stdcall CSchroeder::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity)
{
	return true;
}

bool __stdcall CSchroeder::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff)
{
	return true;
}

// uModValue = 0->127
bool __stdcall CSchroeder::midiModWheel(UINT uChannel, UINT uModValue)
{
	return true;
}
...
bool __stdcall CSchroeder::midiPitchBend(UINT uChannel, int nActualPitchBendValue, float fNormalizedPitchBendValue)
{
	return true;
}
...
*/
bool __stdcall CSchroeder::midiClock()
{
...
bool __stdcall CSchroeder::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
						   				  cData1, unsigned char cData2)
{
	return true;
}

void* __stdcall CSchroeder::showGUI(void* pInfo)
{
...
bool __stdcall CSchroeder::initUI()
{
	// ADDED BY RACKAFX -- DO NOT EDIT THIS CODE!!! -------------------------------------- //
...
// **--0xDEA7--**
	...
	ui1->fUserDisplayDataHiLimit = 10000.000000;
	ui1->uUserDataType = floatData;
	ui1->fInitUserIntValue = 0;
	ui1->fInitUserFloatValue = 800.000000;
	ui1->fInitUserDoubleValue = 0;
	ui1->fInitUserUINTValue = 0;
	ui1->m_pUserCookedIntData = NULL;
	ui1->m_pUserCookedFloatData = &m_fRT60_mS;
	ui1->m_pUserCookedDoubleData = NULL;
	ui1->m_pUserCookedUINTData = NULL;
	ui1->cControlUnits = "mS                                                              ";
	ui1->cVariableName = "m_fRT60_mS";
	ui1->cEnumeratedList = "SEL1,SEL2,SEL3";
	ui1->dPresetData[0] = 800.000000;ui1->dPresetData[1] = 0.000000;ui1->dPresetData[2] = 0.000000;ui1->dPresetData[3] = 0.000000;ui1->dPresetData[4] = 0.000000;ui1->dPresetData[5] = 0.000000;ui1->dPresetData[6] = 0.000000;ui1->dPresetData[7] = 0.000000;ui1->dPresetData[8] = 0.000000;ui1->dPresetData[9] = 0.000000;ui1->dPresetData[10] = 0.000000;ui1->dPresetData[11] = 0.000000;ui1->dPresetData[12] = 0.000000;ui1->dPresetData[13] = 0.000000;ui1->dPresetData[14] = 0.000000;ui1->dPresetData[15] = 0.000000;
	ui1->cControlName = "Decay";
	...
	ui2->m_pUserCookedFloatData = &m_fPredelay_mS;
	ui2->m_pUserCookedDoubleData = NULL;
	ui2->m_pUserCookedUINTData = NULL;
	ui2->cControlUnits = "mS                                                              ";
	ui2->cVariableName = "m_fPredelay_mS";
	ui2->cEnumeratedList = "SEL1,SEL2,SEL3";
	ui2->dPresetData[0] = 40.000000;ui2->dPresetData[1] = 0.000000;ui2->dPresetData[2] = 0.000000;ui2->dPresetData[3] = 0.000000;ui2->dPresetData[4] = 0.000000;ui2->dPresetData[5] = 0.000000;ui2->dPresetData[6] = 0.000000;ui2->dPresetData[7] = 0.000000;ui2->dPresetData[8] = 0.000000;ui2->dPresetData[9] = 0.000000;ui2->dPresetData[10] = 0.000000;ui2->dPresetData[11] = 0.000000;ui2->dPresetData[12] = 0.000000;ui2->dPresetData[13] = 0.000000;ui2->dPresetData[14] = 0.000000;ui2->dPresetData[15] = 0.000000;
	ui2->cControlName = "Predelay";
	...
	ui3->fInitUserFloatValue = 0.250000;
	ui3->fInitUserDoubleValue = 0;
	ui3->fInitUserUINTValue = 0;
	ui3->m_pUserCookedIntData = NULL;
	ui3->m_pUserCookedFloatData = &m_fLPF_in_g;
	ui3->m_pUserCookedDoubleData = NULL;
	ui3->m_pUserCookedUINTData = NULL;
	ui3->cControlUnits = "Units                                                           ";
	ui3->cVariableName = "m_fLPF_in_g";
	ui3->cEnumeratedList = "SEL1,SEL2,SEL3";
	ui3->dPresetData[0] = 0.250000;ui3->dPresetData[1] = 0.000000;ui3->dPresetData[2] = 0.000000;ui3->dPresetData[3] = 0.000000;ui3->dPresetData[4] = 0.000000;ui3->dPresetData[5] = 0.000000;ui3->dPresetData[6] = 0.000000;ui3->dPresetData[7] = 0.000000;ui3->dPresetData[8] = 0.000000;ui3->dPresetData[9] = 0.000000;ui3->dPresetData[10] = 0.000000;ui3->dPresetData[11] = 0.000000;ui3->dPresetData[12] = 0.000000;ui3->dPresetData[13] = 0.000000;ui3->dPresetData[14] = 0.000000;ui3->dPresetData[15] = 0.000000;
	ui3->cControlName = "Input Damping Gain";
	...
	ui4->m_pUserCookedFloatData = &m_fLPF_out_g;
